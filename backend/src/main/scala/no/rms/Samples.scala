  ...
  def products = {
    Product("Produkter", "", Seq(
      Product("Eksteriør", "", Seq(
        ...
        Product("Faste skjermer", "", Seq(
          Product("Med C lameller", ""),
          Product("Hedding fastskjermer", "???")
        )),
        Product("Spesialløsinger", "", Seq(
          Product("Tess 420", ""),
          Product("Tess 421", ""),
          Product("Tess 440", ""),
          Product("Omega 1", "")
      ...
      Product("Interiør", "", Seq(
        ...
        Product("Rullegardin EOS 500", "Hunter Douglas® Rullegardiner er en mye brukt som dekorativ og funksjonell solskjerming. De kan lett tilpasses de fleste situasjoner, trengerliten monteringsplass og når de er opprullet er de nestenusynlige. Gardinene kan senkes til enhver ønsket posisjon. Brukeren kan stengeute sterkt sollys og beholder i de fleste tilfeller muligheten til å se ut i nederste del av vinduet."),
        ...
        Product("Multifilm", "Den perfekte løsningen for varme og lysdemping – alt i ett produkt.", Seq(
          Product("Miltidecor Screen+", ""),
          Product("Rullegardin (tekstil)", ""),
          Product("Rullegradin (film)", ""),
          Product("Film-fasase systemer", "")
        ))
      )),
